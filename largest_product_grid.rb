...
def grids_4_by_4_from(grid_20_by_20)
  grids = []
  (0..16).each do |y_coord|
    (0..16).each do |x_coord|
      grid = [
        grid_20_by_20[y_coord][x_coord..x_coord+3], 
        grid_20_by_20[y_coord+1][x_coord..x_coord+3], 
        grid_20_by_20[y_coord+2][x_coord..x_coord+3],
        grid_20_by_20[y_coord+3][x_coord..x_coord+3]
      ]
      grids << grid
    end
  end
...
def largest_product(grid)
  grids = grids_4_by_4_from(grid)
  largest_product = 0
  grids.each do |grid|
    binding.pry
    product = largest_product_4_by_4(grid)
...
puts largest_product(twenty_by_twenty_grid)